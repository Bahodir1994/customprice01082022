                            ...
                            <div class="our_solution_category">
                                <div class="solution_cards_box">
                                    <div class="solution_card" onclick="DigestsFirst(0)">
                                        ...
                                        <div class="solu_title">
                                            <h3>ШАРТЛИ БЕЛГИЛАНГАН ТОВАРЛАР</h3>
                                        </div>
                                        <div class="solu_description">
                                            <p>
                                                ШАРТЛИ БОЖХОНА ҚИЙМАТИНИ БЕЛГИЛАШ ОРҚАЛИ ТОВАРЛАРНИ ЧИҚАРИШ
                                            </p>
                                ...
                                <div class="solution_cards_box">
                                    <div class="solution_card">
                                        ...
                                        <div class="solu_title">
                                            <h3>ХОРИЖИЙ БОЖХОНА ХИЗМАТИ МАЪЛУМОТЛАРИ</h3>
                                        </div>
                                        <div class="solu_description">
                                            <p>
                                                -------------------------------
                                    ...
                                    <div class="solution_card">
                                        ...
                                        <div class="solu_title">
                                            <h3>НАРХ МАЪЛУМОТЛАРИ БЮЛЕТЕНИ</h3>
                                        </div>
                                        <div class="solu_description">
                                            <p>
                                                -------------------------------
                                ...
                                <div class="solution_cards_box">
                                    ...
                                    <div class="solution_card" onclick="BYDHistory(0)">
                                        ...
                                        <div class="solu_title">
                                            <h3>БОЖХОНА ЮК ДЕКЛАРАЦИЯЛАРИ ТАРИХИ</h3>
                                        </div>
                                        <div class="solu_description">
                                            <p>
                                                -------------------------------
                                ...
                                <div class="solution_cards_box">
                                    <div class="solution_card">
                                        ...
                                        <div class="solu_title">
                                            <h3>БОЖХОНА ҚИЙМАТИНИ ХАВОЛА ҚИЛИШ ТАРИХИ</h3>
                                        </div>
                                        <div class="solu_description">
                                            <p>
                                                ------------------------
                                    ...
                                    <div class="solution_card">
                                        ...
                                        <div class="solu_title">
                                            <h3>БОЖХОНА ҚИЙМАТИ БЎЙИЧА МАВЖУД ХАТОЛИКЛАР</h3>
                                        </div>
                                        <div class="solu_description">
                                            <p>
                                                ------------------------
