        ...
        <div class="card">
            <div class="fm-search m-3">
                <div class="mb-0">
                    <div class="row">
                        ...
                        <div class="col-md-2 m-2">
                            <label class="">Юк жўнатувчи мамлакат</label>
                        ...
                        <div class="col-md-2 m-2">
                            <button type="button" class="btn btn-primary btn-block mt-3" onclick="searchResultTableMtcRepl(0)"><i class='bx bx-refresh'></i>Излаш</button>
            ...
            <div class="col-sm-8" id="divRowCount" style="display: none; margin-left: 15px!important;">
                <div class="col-md-1 text-primary">
                    <select class="form-select" id="size" name="size" onchange="searchResultTableMtcRepl(0)">
...
<script>
    ...
    function searchResultTableMtcRepl(x) {
        var log_f = true;
        var log_n = '';
        var arr = [];
        var gtk = 0, err = 1;
        ...
        var dataS = {
            ...
            "g7a": $('#postId').val(),
            "gdvipdate1S": $('#gdvipdate1').val(),
            "gdvipdate2S": $('#gdvipdate2').val(),
            "g11": $('#g11').val(),
            "g15": $('#g15').val(),
            "g34": $('#g34').val(),
            "g33": $('#g33').val(),
        ...
        if (gtk === 1) {
            $.ajax({
                type: "GET",
                data: dataS,
                url: "<%=request.getContextPath()%>/costmonitoring/resources/pages/CostMonitoring/MtcRepl/ResultCM",
                dataType: "html",
