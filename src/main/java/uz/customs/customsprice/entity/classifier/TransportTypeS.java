...
public class TransportTypeS extends AbstractAuditingEntity {
    @Id
    ...
    public TransportTypeS(String insUser, String updUser, Date insTime, Date updTime, int isDeleted, String code, String cdDesc, String cdId, String cdIdL, String cdNm, String cdOrdr, String lngaTpcd, String useYN) {
